...
#DIALYZER_DEPS_INC = $(foreach dep,$(DEPS_LIST),-I deps/$(dep)/include)
DEPS_PLT = deps.plt
...
dialyzer: $(BASIC_PLT) $(DEPS_PLT)
	...
	--plts ~/.dialyzer_plt $(DEPS_PLT) \
	--src src \
	-r ebin \
	-I deps

$(DEPS_PLT):
	dialyzer --build_plt $(DIALYZER_DEPS) --output_plt $(DEPS_PLT) || true
endif

$(BASIC_PLT):
	@echo "building $(BASIC_PLT) ..."
	$(DIALYZER) --build_plt --output_plt $(BASIC_PLT) --apps $(DIALYZER_APPS) || true
